  ...
  firstUpdated(){
    ...
    auth.trackSession(session => {
      if (!session){
        ...
        this.agent.sendMulti(['Webid','App', 'Post', 'Fab', 'NoteDev', 'MediaDev'], {action: "sessionChanged", webId: null});
      /*  var n = new Notification('Goodbye', {
        ...
        this.agent.sendMulti(['Webid','App', 'Post', 'Fab', "NoteDev", 'MediaDev'], {action: "sessionChanged", webId: app.webId});
